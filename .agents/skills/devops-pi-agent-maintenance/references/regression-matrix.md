...
| Subagent extension | Parent/child authority boundary; execution-capable reviewer without write/edit; repository-scoped parent/worker review gate; semantic pass versus blocked/fail/missing verdict; partial/final behavior; stale/failed/reset behavior; profile/tool allowlist; role single/parallel limits; structured timeout/abort/process failure; bounded reviewer output; no paid provider call in unit tests |
